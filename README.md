...
## Author : [ABDUL SAMAD ABOOBAKAR](https://www.linkedin.com/in/abdul-samad-aboobakar-69ba12a9) 
...
|       SL. NO        |                                    Outline                                      |
| :-----------------: | :-----------------------------------------------------------------------------: |
|          1          |                              [Executive Summary](https://github.com/samad-git-89/spacex-falcon9-capstone/edit/main/README.md#executive-summary)                                 |
|          2          |                                 [Introduction](https://github.com/samad-git-89/spacex-falcon9-capstone/edit/main/README.md#introduction)                                    |
|          3          |                                   [Objective](https://github.com/samad-git-89/spacex-falcon9-capstone/edit/main/README.md#objective)                                     |
|          4          |                       [Hardware and Software Requirments](https://github.com/samad-git-89/spacex-falcon9-capstone/edit/main/README.md#hardware-and-software-requirments)                         |
|          5          |                                  [Methodology](https://github.com/samad-git-89/spacex-falcon9-capstone/edit/main/README.md#methodology)                                    |
|          6          |                  [Insights Drawn from Exploratory Data Analysis](https://github.com/samad-git-89/spacex-falcon9-capstone/edit/main/README.md#insights-drawn-from-exploratory-data-analysis)                  |
|          7          |                        [Launch Sites Proximities Analysis](https://github.com/samad-git-89/spacex-falcon9-capstone/edit/main/README.md#launch-sites-proximities-analysis)                        |
|          8          |                       [Build A Dashboard with Plotly Dash](https://github.com/samad-git-89/spacex-falcon9-capstone/edit/main/README.md#build-a-dashboard-with-plotly-dash)                        |
|          9          |                       [Predictive Analysis (Classification)](https://github.com/samad-git-89/spacex-falcon9-capstone/edit/main/README.md#predictive-analysis-classification-1)                        |
|          10         |                                  [Conclusion](https://github.com/samad-git-89/spacex-falcon9-capstone/edit/main/README.md#conclusion)                                     |
...
### To see the code and step by step process of Data Collection using SpaceX API [CLICK HERE](https://github.com/samad-git-89/SpaceX-Data-Collection-API/blob/main/jupyter-labs-spacex-data-collection-api.ipynb)
...
### To see the code and step by step process of Data Collection with Web Scrapping [CLICK HERE](https://github.com/samad-git-89/spacex-falcon9-capstone/blob/main/spacex-falcon9-capstone/notebooks/Web-scraping-Falcon-9-and-Falcon-Heavy-Launches-Records-from-Wikipedia-main/jupyter-labs-webscraping.ipynb)
...
### To see the code and step by step process of Data Wrangling [CLICK HERE](https://github.com/samad-git-89/spacex-falcon9-capstone/blob/main/spacex-falcon9-capstone/notebooks/Data-Wrangling-main/labs-jupyter-spacex-Data%20wrangling.ipynb)
...
### To see the code and step by step process of EDA With SQL [CLICK HERE](https://github.com/samad-git-89/spacex-falcon9-capstone/blob/main/spacex-falcon9-capstone/notebooks/EDA-with-SQL-main/jupyter-labs-eda-sql-coursera_sqllite.ipynb)
...
### To see the code and step by step process of EDA with Data Visualization [CLICK HERE](https://github.com/samad-git-89/spacex-falcon9-capstone/blob/main/spacex-falcon9-capstone/notebooks/Exploring-Data-of-SpaceX-falcon-9-Landing-prediction-main/edadataviz_module_2.ipynb)
...
### To see the code and step by step process of Build an Interactive Map with Folium [CLICK HERE](https://github.com/samad-git-89/spacex-falcon9-capstone/blob/main/spacex-falcon9-capstone/notebooks/Interactive-Visual-Analytics-with-Folium-main/lab_jupyter_launch_site_location.ipynb)
...
### To see the code and step by step process of Predictive Analysis (Classification) [CLICK HERE](https://github.com/samad-git-89/spacex-falcon9-capstone/blob/main/spacex-falcon9-capstone/notebooks/ML_Prediction-main/SpaceX_Machine%20Learning%20Prediction_Part_5.ipynb)
...
### To See the code for making the Dashboard using Plotly Dash [CLICK HERE](https://github.com/samad-git-89/spacex-falcon9-capstone/blob/main/spacex-falcon9-capstone/dashboard/Build-an-Interactive-Dashboard-with-Plotly-Dash-main/spacex-dash-app.py) 
